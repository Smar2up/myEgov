		...
		<div class="header">
			<div class="header-title">
				...
				<span class="headerButtons" style="width: 300px; text-align: right;">
					<button class="btn_search" onclick="location.href='empInfo.do'">조회</button>
					<button class="btn_input" id="input_submit">입력</button>
		...
		<div class="body1" >사원목록<br>
			<div style="overflow-x:hidden; height:350px; border:1px solid #cccccc; text-align: center;">
				...
				<table border="1px" bordercolor="#DCDADA">
					...
					<tr bgcolor="#E0ECF8">
						<th ><input type="checkbox" name="empListCheck" id="empListCheck1"></th>
						<td> </td>
						<td> Maria Kim</td>
						<td> TS0001 </td>
						<td> 부장 </td>
